    ...
    if update.get('message'):
        ...
        if message_text.startswith('/'):
            ...
            if command == '/start':
                ...
                response_text = f'Welcome {players[player_id].full_name}! Use /balance to check your balance and /bet to place a bet. Visit https://gamblingminiapp.vercel.app to deposit.'
